...
export declare class AdminController {
    ...
    approve(driverId: string, user: any): Promise<{
        ok: boolean;
        driver: {
            id: string;
            city: import(".prisma/client").$Enums.City;
    ...
    reject(driverId: string, body: any, user: any): Promise<{
        ok: boolean;
        driver: {
            id: string;
            city: import(".prisma/client").$Enums.City;
    ...
    suspend(driverId: string, body: any, user: any): Promise<{
        ok: boolean;
        driver: {
            id: string;
            city: import(".prisma/client").$Enums.City;
    ...
    unsuspend(driverId: string, user: any): Promise<{
        ok: boolean;
        driver: {
            id: string;
            city: import(".prisma/client").$Enums.City;
